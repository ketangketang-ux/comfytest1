...
@app.function(
    timeout=600,
    volumes={"/data": VOL},
    secrets=[modal.Secret.from_name("civitai-secret")],  # <-- TOKEN di sini
)
def download_basemodel():
    ...
    if not civitai_token:
        raise Exception("❌ CIVITAI_TOKEN tidak ditemukan di secrets Modal!")
    ...
    print("🎉 DONE! Base model tersimpan di volume Modal.")
